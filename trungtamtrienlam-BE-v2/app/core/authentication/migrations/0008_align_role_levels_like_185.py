...
def align_role_levels_like_185(apps, schema_editor):
...
def reverse_role_levels_low_to_high(apps, schema_editor):
    Role = apps.get_model('authentication', 'Role')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0007_align_role_levels_low_to_high'),
    ]

    operations = [
        migrations.RunPython(align_role_levels_like_185, reverse_role_levels_low_to_high),
    ]
