...
class OrganizationAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'code', 'is_deleted', 'created_at']
...
class StaffFileAdmin(admin.ModelAdmin):
    list_display = ['id', 'staff', 'user_id', 'type_file', 'file_name', 'is_deleted', 'created_at']
...
class UserConcurrentlyAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'role', 'department', 'organization', 'is_deleted', 'created_at']
