...
def align_role_levels_by_hierarchy(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0008_align_role_levels_like_185'),
    ]

    operations = [
        migrations.RunPython(align_role_levels_by_hierarchy, reverse_role_levels_like_185),
    ]
